...
const props = defineProps<{ open: boolean; facultadId: number }>()
const emit = defineEmits(['close'])

const confirmDelete = () => {
  router.delete(facultad.destroy(props.facultadId).url, {
    ...
    <AlertDialogPortal>
      ...
      <AlertDialogContent
        ...
        <AlertDialogDescription class="mt-4 mb-5 text-sm leading-normal dark:text-black">
          Esta acción no se puede deshacer. Se eliminará permanentemente la facultad y sus datos asociados.
        </AlertDialogDescription>

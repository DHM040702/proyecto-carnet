...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center bg-gradient-to-b from-white to-[#eff6ff] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-gradient-to-b dark:from-[#0a0a0a] dark:to-[#1e3a8a]"
    >
        <header
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                ...
                <template v-else>
                    <Link
                        :href="login()"
                        class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-[#1e40af] hover:border-[#1e40af] dark:text-[#60a5fa] dark:hover:border-[#60a5fa]"
                    >
                        Iniciar sesión
                    </Link>
                    <Link
                        v-if="canRegister"
                        :href="register()"
                        class="inline-block rounded-sm border border-[#1e40af] px-5 py-1.5 text-sm leading-normal text-[#1e40af] hover:border-[#1e3a8a] hover:bg-[#eff6ff] dark:border-[#60a5fa] dark:text-[#60a5fa] dark:hover:border-[#3b82f6] dark:hover:bg-[#1e3a8a]"
                    >
                        Registrarse
                    </Link>
                </template>
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-3 text-2xl font-bold text-[#1e40af] dark:text-[#60a5fa]">Sistema de Emisión de Carné Universitario - SECU</h1>
                    <p class="mb-6 text-[14px] leading-relaxed text-[#374151] dark:text-[#9CA3AF]">
                        El Sistema de Emisión de Carné Universitario es una aplicación diseñada para gestionar, registrar y controlar la emisión de carnés de identificación para estudiantes universitarios. El sistema permite administrar de manera eficiente la información del estudiante, validar su condición académica y generar el carné universitario de forma ordenada, segura y trazable.
                    </p>
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                href="#"
                                class="inline-block rounded-sm border border-[#1e40af] bg-[#1e40af] px-5 py-1.5 text-sm leading-normal text-white hover:border-[#1e3a8a] hover:bg-[#1e3a8a] dark:border-[#60a5fa] dark:bg-[#60a5fa] dark:text-[#1C1C1A] dark:hover:border-[#3b82f6] dark:hover:bg-[#3b82f6]"
                            >
                                Comenzar
                            </a>
                        </li>
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-gradient-to-br from-[#dbeafe] to-[#bfdbfe] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-gradient-to-br dark:from-[#1e3a8a] dark:to-[#1e40af]"
                >
                    <svg

...
class SemestresSeeder extends Seeder
{
    ...
    public function run()
    {
        Semestre::insert([
            ...
            ['semestre' => '2026-1' , 'fecha_inicio' => '2026-03-23' , 'fecha_fin' =>null , 'fecha_inicio_solicitud' => '2026-04-10' , 'fecha_fin_solicitud' => null , 'usercreacion' => 'SEEDER' , 'created_at' => now() , 'updated_at' => now()]
        ]);
    }
}
